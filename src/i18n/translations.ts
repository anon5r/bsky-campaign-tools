...
export const translations = {
  en: {
    appTitle: 'Bsky Campaign Tools',
    homeTitle: 'Campaign Tools for Bluesky',
    ...
    status: 'Status:',
    interactionsLoaded: (n: number, t: number | null) => `RP Loaded: ${n} ${t ? `(Total ~${t})` : ''}`,
    ...
    fetchedInteractions: (n: number) => `Fetched ${n} RPs.`,
    fetchError: 'Error fetching RPs.',
  ...
  ja: {
    ...
    status: 'ステータス:',
    interactionsLoaded: (n: number, t: number | null) => `取得したRP/引用: ${n}件 ${t ? `(全体 ~${t}件)` : ''}`,
    ...
    fetchedInteractions: (n: number) => `${n} 件のRP/引用を取得しました。`,
    fetchError: 'RP/引用の取得中にエラーが発生しました。',
